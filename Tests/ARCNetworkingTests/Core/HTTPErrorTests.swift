...
@Suite("HTTPError") struct HTTPErrorTests {
    @Test("Description for invalidURL") func invalidURLDescription() {
    ...
    @Test("Description for decodingFailed includes underlying error") func decodingFailedDescription() {
    ...
    @Test("Description for unknown includes the underlying error message") func unknownDescription() {
